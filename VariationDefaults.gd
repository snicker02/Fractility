...
## --- Gnarl A ---
@export var gnarl_mode_a: int = 1         # 1-8
@export var gnarl_scale_x_a: float = 0.5  # Strength X
@export var gnarl_scale_y_a: float = 0.5  # Strength Y
@export var gnarl_freq_x1_a: float = 3.5
@export var gnarl_freq_y1_a: float = 3.5
@export var gnarl_freq_x2_a: float = 2.0
@export var gnarl_freq_y2_a: float = 2.0
@export var gnarl_freq_x3_a: float = 5.0
@export var gnarl_freq_y3_a: float = 5.0
@export var gnarl_c1_a: float = 5.0       # Color/Phase 1
@export var gnarl_c2_a: float = 5.0       # Color/Phase 2
@export var gnarl_distort_a: float = 0.0  # Log Distortion
@export var gnarl_scale_x_a_speed: float = 0.0
@export var gnarl_scale_y_a_speed: float = 0.0
@export var gnarl_freq_x1_a_speed: float = 0.0
@export var gnarl_freq_y1_a_speed: float = 0.0
@export var gnarl_freq_x2_a_speed: float = 0.0
@export var gnarl_freq_y2_a_speed: float = 0.0
@export var gnarl_freq_x3_a_speed: float = 0.0
@export var gnarl_freq_y3_a_speed: float = 0.0
@export var gnarl_c1_a_speed: float = 0.0
@export var gnarl_c2_a_speed: float = 0.0
@export var gnarl_distort_a_speed: float = 0.0
## --- Gnarl B ---
@export var gnarl_mode_b: int = 1
@export var gnarl_scale_x_b: float = 0.5
@export var gnarl_scale_y_b: float = 0.5
@export var gnarl_freq_x1_b: float = 3.5
@export var gnarl_freq_y1_b: float = 3.5
@export var gnarl_freq_x2_b: float = 2.0
@export var gnarl_freq_y2_b: float = 2.0
@export var gnarl_freq_x3_b: float = 5.0
@export var gnarl_freq_y3_b: float = 5.0
@export var gnarl_c1_b: float = 5.0
@export var gnarl_c2_b: float = 5.0
@export var gnarl_distort_b: float = 0.0
@export var gnarl_scale_x_b_speed: float = 0.0
@export var gnarl_scale_y_b_speed: float = 0.0
@export var gnarl_freq_x1_b_speed: float = 0.0
@export var gnarl_freq_y1_b_speed: float = 0.0
@export var gnarl_freq_x2_b_speed: float = 0.0
@export var gnarl_freq_y2_b_speed: float = 0.0
@export var gnarl_freq_x3_b_speed: float = 0.0
@export var gnarl_freq_y3_b_speed: float = 0.0
@export var gnarl_c1_b_speed: float = 0.0
@export var gnarl_c2_b_speed: float = 0.0
@export var gnarl_distort_b_speed: float = 0.0
